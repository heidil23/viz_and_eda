...
count month / name observations summarize by naming a variable and
defining a function
...
we can use`count()` as well if we are only counting things, does the
same as above
...
**NEVER** use base R’s `table` Problems: result is not a data frame,
requires taking data out of a data frame
...
n\_distinct tells you how many unique dates there are in each category
...
TRUE \~ "" accounts for what to do with values that are missed by the
...
<img src="visualization_part3_files/figure-gfm/unnamed-chunk-14-1.png" width="90%" />
...
```
    ...
    ##  3 CentralPark_NY USW000947… 2017-01-03   147   6.1   3.9 2017-01-01       1.1  
    ...
    ##  9 CentralPark_NY USW000947… 2017-01-09     0  -4.9  -9.9 2017-01-01      -1.10 
